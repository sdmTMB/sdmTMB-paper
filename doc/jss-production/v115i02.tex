...
Meshes generated with \pkg{fmesher} may differ slightly across CPU architectures and compiler settings due to platform-specific floating-point arithmetic, which can lead to minor differences in parameter estimates.
Results shown here were produced with \proglang{R} 4.5.2 on Ubuntu 22.04.5 LTS (\code{x86\_64-pc-linux-gnu}).
